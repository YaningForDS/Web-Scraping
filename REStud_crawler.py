...
pre_linklist = ['https://www.jstor.org/journal/revieconstud?decade=2010','https://www.jstor.org/journal/revieconstud?decade=2000',
'https://www.jstor.org/journal/revieconstud?decade=1990']

class crawler_REStud():
    ...
    def get_linklist(self):
        ...
        for item in pre_linklist:
            ...
            for i in li_of_link:
                pre = 'http://www.jstor.org/stable/'
                linklist.append(pre+str(i.get('href'))[1:].split('/')[-1])
        return linklist
...
crawler = crawler_REStud('REStud_res')
crawler.crawler()
